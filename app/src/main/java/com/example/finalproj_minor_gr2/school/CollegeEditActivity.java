package com.example.finalproj_minor_gr2.school;
...
public class CollegeEditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void BindViews() {
        ...
        etUsernameStud = findViewById(R.id.etUsernameClg);
        etCourseStud = findViewById(R.id.etCourseClg);
        etLocationStud = findViewById(R.id.etLocationClg);
        etDescStud = findViewById(R.id.etDescClg);
        updateStudentInfo = findViewById(R.id.updateClgInfo);

        etQualStud = findViewById(R.id.etQualClg);
