...
public class FollowedStudentActivity extends AppCompatActivity {
    ...
    private void BindViews() {
        rcv_followed_users = findViewById(R.id.rcv_followed_students);
        customAdapterRcvSearchTeacher = new CustomAdapterRcvSearchTeacher(FollowedStudentActivity.this, list);
